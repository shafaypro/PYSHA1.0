...
pickle.dump(classifier,save_classifier)  # Save the Classified in to the FFile (save_calssifier which iss in the form of the Bytes !)
save_classifier.close() # this closes the Classifier which saves the Data
# since the basic classifiers are being stored in the data , and keep in mind hte bayes law hyphotheses !